...
const Experience = () => {
  const techs = [
    ...
    return (
    <div name='experience' className='bg-gradient-to-b from-gray-800 to-black text-white md:h-full'>
        <div className='flex flex-col p-4 max-w-screen-lg mx-auto justify-center w-full h-full'>
            <div className='mt-20'>
